...
public class Cen2PeppolCn extends AbstractFromCenConverter {
    ...
    public void configure() throws ConfigurationException {
        ...
        try {
            ...
            cenValidator = new CiusSchematronValidator(cenSchemaFile, true, schematronAutoUpdate, ErrorCode.Location.PEPPOLCN_OUT);
            ublValidator = new SchematronValidator(ublSchemaFile, true, schematronAutoUpdate, ErrorCode.Location.PEPPOLCN_OUT);
        } catch (Exception e) {
